...
public class BikeFlagEncoder extends AbstractFlagEncoder
{
    ...
    public BikeFlagEncoder( int speedBits, double speedFactor )
    {
    ...
    public long acceptWay( OSMWay way )
    {
        ...
        if (highwayValue == null)
        {
            ...
            {
                String golfcartTag = way.getTag("golf_cart");
                if (golfcartTag == null || "yes".equals(golfcartTag))
    ...
    void collect( OSMWay way, TreeMap<Double, Integer> weightToPrioMap )
    {
        ...
        if (way.hasTag("golf_cart", "designated"))
